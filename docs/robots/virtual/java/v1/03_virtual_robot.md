...
You need to fork and/or clone the repository, [Pera-Swarm/java-robot](https://github.com/Pera-Swarm/java-robot) into your environment, and setup by following the instructions on [Java Robot](01_setup_guide.md).
...
![Robot State Machine Model of the Robot](../../../../../assets/images/java-robot/virtual-robot-states.jpg)
...
2. Next, you need to configure the `App.java` file in the folder, `/src/main/java/`, by creating one or more Virtual Robot Objects using the Class you implemented, by defining the start coordinates and heading directions of each Virtual Robot object. A detailed guide can be found on [here](05_swarm_class.md).
3. Running instructions can be found on the [Java Robot](01_setup_guide.md).
