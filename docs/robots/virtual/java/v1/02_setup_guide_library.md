---
title: "Setup Guide - Robot Library"
nav_order: 2
---

## Setup Guide - Robot Library
...
If you need to update the core functionalities, while the robot implementations, you need to  fork and clone the repository, [Pera-Swarm/robot-library-java](https://github.com/Pera-Swarm/robot-library-java) first. Then you need to install the dependencies and compile the project with your changes, and later work on a release.
...
- Download the repository from [Pera-Swarm/robot-library-java](https://github.com/Pera-Swarm/robot-library-java)
...
:::note
It is assumed that you already installed _Java Runtime Environment_ and _Maven Build Tool_.
:::
...
- Next, you can use the following code block to use the Java Library on your Maven Projects. Replace the &lt;version&gt;1.0.0&lt;/version&gt; with the version you want to use. (Please note that to use this Maven library, you need to Authenticate with a GitHub token. Further info is available [here](01_setup_guide.md).)
